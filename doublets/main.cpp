...
int main()
{
  ...
  valid = valid_step("TEA", "TEA");
  cout << "From 'TEA' to 'TEA' is " << (valid ? "" : "NOT ") << "a valid step." << endl << endl;
 ...
 valid = valid_chain(wheat_chain);
  ...
  const char *repeat_chain2[] = { "WHEAT", "CHEAT", "WHEAT", "CHEAT", NULL };
  valid = valid_chain(repeat_chain2);
  cout << "The chain 'WHEAT->CHEAT->WHEAT->CHEAT' is " << (valid ? "" : "NOT ") << "a valid chain." << endl << endl;
