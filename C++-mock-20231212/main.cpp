...
cout << "The edit distance between 'door' and 'dog' is " << edit_distance("door","dog") << endl;
cout << "The edit distance between 'door' and 'dog' is " << edit_distance("dog","door") << endl;
cout << "The edit distance between 'chess' and 'makefile' is " << edit_distance("chess","makefile") << endl;
cout << "The edit distance between 'makefile' and 'chess' is " << edit_distance("makefile","chess") << endl;
cout << "The edit distance between 'house' and 'hi' is " << edit_distance("house","hi") << endl;
